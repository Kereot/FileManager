package main.java.ru.gb.filemanager;
...
public class Controller {
    ...
    public void loginBtnAction(ActionEvent actionEvent) { //just a placeholder
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(MainApp.class.getResource("/main/resources/main.fxml"));
    ...
    public static void loginWindow(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(MainApp.class.getResource("/main/resources/login.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 1280, 600);
        stage.setTitle("File Manager");
        stage.setScene(scene);
        stage.show();
